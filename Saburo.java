public class Saburo {
  ...
  // 三郎が食べる処理
  public static void eatSaburo(int[] personData, String fruit, String[] fruitData) {
    // りんご
